...
SECRET_KEY = 'django-insecure-*3g7zi5_c%-gn!esqo8k%nf4h2s(w&jnomf2#aer7^&#e9khfe'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'memearena'),
...
CELERY_BEAT_SCHEDULE = {
    'pick-meme-of-day-daily': {
        'task': 'memes.tasks.pick_meme_of_the_day',
